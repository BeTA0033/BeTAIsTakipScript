...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="img/61947535Beta.png">
      ...
      <div class="card o-hidden border-0 shadow-md" style="min-width: 45%">
       <div class="p-5">
        <div class="text-center">
          <h2 class="h2 text-gray-900 mb-4">Hoşgeldiniz</h2>
        </div>
        <form class="user" action="islemler/islem.php" method="POST">
          ...
          <hr>            
          <p class="text-muted text-center">BeTA İş Takip Scripti</p>
        </form>
        <!--
        <form class="user" action="islemler/islem.php" method="POST">
        <br> <a name="unuttuk" href="./epostasor.php">Şifremi Unuttum</a>
        </form>
        -->
      </div>
    </div>
