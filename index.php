...
<div class="container-fluid p-2">
	...
	<!-- Earnings (Monthly) Card Example End -->
	...
	<div class="row">
		...
		<!-- Earnings (Monthly) Card Example -->
		<?php 
		$siparis_biten_sayi_sor=$db->prepare("SELECT * FROM siparis WHERE YEARWEEK(sip_teslim_tarihi) = YEARWEEK(CURDATE()) ORDER BY sip_teslim_tarihi DESC");
		...
		<div class="card border-left-warning shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Teslimi <b>Bu Hafta</b> Olan/Olacak Sipariş Sayısı</div>
		...
		<div class="col-md-14">
			<div class="card shadow mb-4">
				<div class="card-header py-3 text-center">
					<h5 class="m-0 font-weight-bold text-primary">Teslimi Bu Hafta Olan/Olacak Siparişler</h5>
				</div>
				<div class="card-body" style="width: 100%">
					...
					<div class="table-responsive">
						<table class="table table-bordered" id="siparistablosu" width="100%" cellspacing="0">
							...
							<tbody>
								<?php 
								$siparissor=$db->prepare("SELECT * FROM siparis WHERE YEARWEEK(sip_teslim_tarihi) = YEARWEEK(CURDATE()) ORDER BY sip_teslim_tarihi DESC");
								//$siparissor=$db->prepare("select * from siparis WHERE YEARWEEK(NOW()) = YEARWEEK(sip_teslim_tarihi) ORDER BY sip_teslim_tarihi DESC");
								$siparissor->execute();
